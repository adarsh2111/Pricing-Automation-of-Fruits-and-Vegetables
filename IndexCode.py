...
"""
Created on Fri May 26 20:32:14 2017
...
# -*- coding: utf-8 -*-
"""
Created on Fri May 26 20:25:25 2017
...
for i in range(0,mpriced['SKUName'].count()):
        if(mpriced['T-1 WS'][i]=='-'):
            ...
            if (mpriced['SKUClassification'][i]=="Leaves"):
                index.append([date,15,"Wholesale Index",mpriced['SKUID'][i],mpriced['SKUName'][i],mpriced['T-1 NC_Retail'][i],mpriced['T-1 WS'][i],8])
                ...
                if(t==0):
                    ...
                    for j in range(1,5):
                        if((mpriced['WS'+str(j)][i]==mpriced['T-1 WS'][i])and(mpriced['Retail'+str(j)][i]==mpriced['T-1 NC_Retail'][i])):
                            ...
                            index.append([date,15,"Wholesale Index",mpriced['SKUID'][i],mpriced['SKUName'][i],mpriced['Retail'+str(j)][i],mpriced['WS'+str(j)][i],"8"])
                            if(wd>=5):
                                wincrease.append(mpriced['SKUName'][i])
                            elif(wd<=-5):
                                wdecrease.append(mpriced['SKUName'][i])
                            elif(rd>=5):
                    ...
                    if(mpriced['GRN_Price'][i]!='-'):
                        if(t==c):
                            ...
                            if ((int(small_ws)-int(mpriced['GRN_Price'][i]))>=5):
                                ...
                                index.append([date,"15","Wholesale Index",mpriced['SKUID'][i],mpriced['SKUName'][i],small,small_ws,"8"])
                                if(wd>=5):
                                    wincrease.append(mpriced['SKUName'][i])
                                elif(wd<=-5):
                                    wdecrease.append(mpriced['SKUName'][i])
                            ...
                            index.append([date,"15","Wholesale Index",mpriced['SKUID'][i],mpriced['SKUName'][i],mpriced['Retail1'][i],mpriced['WS1'][i],"8"])
                            if(wd>=5):
                                wincrease.append(mpriced['SKUName'][i])
                            elif(wd<=-5):
                                wdecrease.append(mpriced['SKUName'][i])
                            ...
                            wd=mpriced['WS1'][i]-mpriced['T-1 WS'][i]
                            rd=mpriced['Retail1'][i]-mpriced['T-1 NC_Retail'][i]
                            index.append([date,"15","Wholesale Index",mpriced['SKUID'][i],mpriced['SKUName'][i],mpriced['Retail2'][i],mpriced['WS2'][i],"8"])
...
index.to_csv('index%s.csv'%date,header=["PurchaseDate","MarketId","Market","SKUId","SKUName","RetailPrice","WholeSalePrice","PriceSource"],index=False)
...
wincrease.to_csv("Wholesale Index Increased by 5 or more List.csv",header=["SKUs"],index=False)
wdecrease.to_csv("Wholesale Index Decreased by 5 or more List.csv",header=["SKUs"],index=False)
